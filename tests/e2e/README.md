...
`npm run test:e2e` construit l'app, la sert sur `http://127.0.0.1:8811/lineup/` et lance chaque `*.test.mjs` de ce dossier (Chromium via playwright-core : `CHROME=/chemin/vers/chrome`, sinon le Chromium de Playwright).
