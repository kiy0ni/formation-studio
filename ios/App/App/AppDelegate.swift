...
/// Prints the formation sheets with the iOS print service (printer, or "Save to Files" as PDF).
@objc(PrintPlugin)
public class PrintPlugin: CAPPlugin, CAPBridgedPlugin {
    public let identifier = "PrintPlugin"
    public let jsName = "FsPrint"
...
/// App screen: the Capacitor web view plus the app's own native plugins.
